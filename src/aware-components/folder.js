...
export default function Folder(props){
	...
	return(
		<FolderBox onClick={()=> dispatch(change({id:props.folder.id,name:props.folder.name,isMain:props.folder.isMain}))} focus={actualFolder === props.folder} active={actualFolder === props.folder}>
			<FolderStatus>
